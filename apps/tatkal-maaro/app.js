// Tatkal Maaro — a Tatkal-rush simulator for the homesick. You pick a route,
...
function renderTicket() {
  ...
  document.getElementById("share").addEventListener("click", () => {
    ...
    Sticky.share({
      title: "Tatkal Maaro",
      text: `CONFIRMED ${t.coach}/${t.seat} on the ${t.trainName}, ${t.fromCity}→${t.toCity} 🚆 (I'm not actually going anywhere). Tatkal Maaro —`,
    });
  });
}
