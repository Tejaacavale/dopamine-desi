// Jhootha Profit — paper-trading toy. Prices are a SIMULATED random walk (the
...
function renderPortfolio() {
  ...
  if (shareP) shareP.addEventListener("click", () => {
    ...
    Sticky.share({
      title: "Jhootha Profit",
      text: `My paper portfolio is ${verb} ${signed(totalPnl)} (${pct(net, STARTING_CASH).toFixed(1)}%) on Jhootha Profit 📈 fake money, real dopamine. Try it —`,
    });
  });
