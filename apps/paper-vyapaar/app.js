// Paper Vyapaar — paper-trading toy. Prices are a SIMULATED random walk (the
...
function renderPortfolio() {
  ...
  if (shareP) shareP.addEventListener("click", () => {
    ...
    Sticky.share({
      title: "Paper Vyapaar",
      text: `My paper portfolio is ${verb} ${signed(totalPnl)} (${pct(net, STARTING_CASH).toFixed(1)}%) on Paper Vyapaar 📈 fake money, real dopamine. Try it —`,
    });
  });
